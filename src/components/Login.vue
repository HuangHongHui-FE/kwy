    ...
    <div class="login_box">
    	...
    	<el-form label-width="0px" class="login_form" :model="loginForm" :rules="loginFormRules" ref="loginFormRef">
		  ...
		  <el-form-item prop="pwd">
		    <el-input prefix-icon="iconfont icon-3702mima" v-model="loginForm.pwd" type="password"></el-input>
		  </el-form-item>
		  <!-- 按钮区域 -->
	...
	methods: {
		...
		login(){
			this.$refs.loginFormRef.validate(async valid => {
				...
				// console.log(res)
				if(res.meta.status !== 200) return this.$message.error("登录失败,请检查账号或密码输入是否有误！");
